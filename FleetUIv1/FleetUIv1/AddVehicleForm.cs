    ...
    public partial class AddVehicleForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                {
                    Car addCar = new Car(mileAge, plateCode, this.f.countVehicle);
                ...
                {
                    Car addCar = new Car(mileAge, plateCode, this.f.countVehicle, brand, rentCost);
                    if (f.AddCarIntoVehicleFleet(addCar))
                    {
                        MessageBox.Show("Success");
                    }
            ...
            else if (type == "Truck")
            {
                if ((this.brand == null) && (this.rentCost == 0))
                {
                    Truck addCar = new Truck(mileAge, plateCode, this.f.countVehicle);
                ...
                {
                    Truck addCar = new Truck(mileAge, plateCode, this.f.countVehicle, brand, rentCost);
                    if (f.AddTruckIntoVehicleFleet(addCar))
                    {
                        MessageBox.Show("Success");
                    }
