        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            foreach (object o in listVehicle)
            {
                if ((o.GetType()).Equals(typeof(Car)))
                {
                    ...
                    vehicle.SubItems.Add(new ListViewItem.ListViewSubItem() { Text = ((Car)o).carBrand });
                    ...
                    vehicle.SubItems.Add(new ListViewItem.ListViewSubItem() { Text = ((Car)o)._mileAge.ToString() });
                    vehicle.SubItems.Add(new ListViewItem.ListViewSubItem() { Text = ((Car)o)._history.PopRecord().Date.ToString() });
                ...
                else if ((o.GetType()).Equals(typeof(Truck)))
                {
                    ...
                    vehicle.SubItems.Add(new ListViewItem.ListViewSubItem() { Text = ((Truck)o).carBrand });
                    ...
                    vehicle.SubItems.Add(new ListViewItem.ListViewSubItem() { Text = ((Truck)o)._mileAge.ToString() });
                    vehicle.SubItems.Add(new ListViewItem.ListViewSubItem() { Text = ((Truck)o)._history.PopRecord().Date.ToString() });
